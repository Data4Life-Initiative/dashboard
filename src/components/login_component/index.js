...
export class LoginComponent extends React.PureComponent {
  ...
  onFinish = (values) => {
    const verifyOtpDataStatus =
      this.props.otpData.otp != null && this.props.otpData.otp.status === 200;
        ...
        <div className="login-container-main verticalCenter">
          ...
          >
            <div className="login-input-group">
              ...
              {verifyOtpDataStatus && (
                <Space direction="vertical" className="spaceVertical">
                  <Form.Item className="aligncenter  margin-bottom10">
                    Please enter the OTP sent to {this.state.value}
                    <a className="margin5px" onClick={this.onClickChange}>
                      Change
                    </a>
                  </Form.Item>
                  <Form.Item
              ...
              <Form.Item className="aligncenter margin-bottom10">
                ...
                >
                  {verifyOtpDataStatus ? "Verify OTP" : "Request OTP"}
                </Button>
              </Form.Item>
              {verifyOtpDataStatus && (
